...
class C1_BigPictureThinker(CousinAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            been thinking about this for weeks." You believe the gallery should honor G's memory while 
            ...
            IMPORTANT: When speaking in conversations, always refer to your cousins as C2, C3, and C4. 
            Never use "Cousin A/B/C" or "Cousin 1/2/3" - always use the exact names C1, C2, C3, C4.""",
...
class C2_PeoplePerson(CousinAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            You remember how G used to host elegant gallery openings, and you'd watch her work the 
            ...
            concerned about family harmony and often reference how "G would have wanted us to..." 
            You believe the gallery should be a place where people connect, just like G intended. 
            You speak like you're having a heart-to-heart with family, using "we" and "our family" often.
            
            IMPORTANT: When speaking in conversations, always refer to your cousins as C1, C3, and C4. 
            Never use "Cousin A/B/C" or "Cousin 1/2/3" - always use the exact names C1, C2, C3, C4.""",
...
class C3_LogicPowerhouse(CousinAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            You remember how G kept meticulous records of every painting, every sale, every expense. 
            ...
            think this through" and "let me run some numbers." You often reference G's careful 
            management style and say things like "G always said..." You believe the gallery should 
            ...
            IMPORTANT: When speaking in conversations, always refer to your cousins as C1, C2, and C4. 
            Never use "Cousin A/B/C" or "Cousin 1/2/3" - always use the exact names C1, C2, C3, C4.""",
...
class C4_TheDoer(CousinAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            You remember helping G with the physical work - moving paintings, setting up displays, 
            ...
            like "let's just do it" and "I can handle that." You often reference how "G would roll 
            ...
            IMPORTANT: When speaking in conversations, always refer to your cousins as C1, C2, and C3. 
            Never use "Cousin A/B/C" or "Cousin 1/2/3" - always use the exact names C1, C2, C3, C4.""",
